...
class __Mustache_c565ceaa2930db8e0b1237152f1b0ae8 extends Mustache_Template
{
...
';
        ...
        // 'haswelcome' section
        $value = $context->find('haswelcome');
        $buffer .= $this->section9077ec51cb02c416159b234247cb15b5($context, $indent, $value);
        $buffer .= $indent . '                    <div class="ml-auto d-flex">
';
        // 'hascatalogbtn' section
        $value = $context->find('hascatalogbtn');
        $buffer .= $this->section61a2d34d9cee63313ec083dbc6ab600f($context, $indent, $value);
        $buffer .= $indent . '                        ';
...
';
    ...
    private function section9077ec51cb02c416159b234247cb15b5(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '                    ';
                $value = $this->resolveValue($context->find('welcomemessage'), $context);
                $buffer .= $value;
                $buffer .= '
';
                $context->pop();
    ...
    private function section61a2d34d9cee63313ec083dbc6ab600f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '                            ';
                $value = $this->resolveValue($context->find('catalogbtn'), $context);
                $buffer .= $value;
                $buffer .= '
';
                $context->pop();
