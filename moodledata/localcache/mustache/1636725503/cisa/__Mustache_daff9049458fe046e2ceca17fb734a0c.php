...
class __Mustache_daff9049458fe046e2ceca17fb734a0c extends Mustache_Template
{
...
';
        $buffer .= $indent . '             ';
        $value = $this->resolveValue($context->findDot('output.footer_branding'), $context);
        $buffer .= $value;
        $buffer .= '
';
        $buffer .= $indent . '
';
        // 'output.help_desk_link' section
        $value = $context->findDot('output.help_desk_link');
        $buffer .= $this->section226dbd0cd30394199f261c7f7cfd7232($context, $indent, $value);
        $buffer .= $indent . '            
';
        $buffer .= $indent . '            ';
...
';
    ...
    private function section226dbd0cd30394199f261c7f7cfd7232(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
                {{{ output.help_desk_link }}}
            ';
            $result = call_user_func($value, $source, $this->lambdaHelper);
            if (strpos($result, '{{') === false) {
                $buffer .= $result;
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '                ';
                $value = $this->resolveValue($context->findDot('output.help_desk_link'), $context);
                $buffer .= $value;
                $buffer .= '
';
                $context->pop();
