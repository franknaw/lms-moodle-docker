...
class __Mustache_37c68f228d803c9ce64944691e5ddc5c extends Mustache_Template
{
...
';
        $buffer .= $indent . '
';
        if ($partial = $this->mustache->loadPartial('theme_boost/navbar-secure')) {
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '        <div id="page-header" class="row">
';
...
';
        // 'hasblocks' section
        $value = $context->find('hasblocks');
        $buffer .= $this->sectionC5ce88c6fb6ec4151f3c426f105e2896($context, $indent, $value);
        $buffer .= $indent . '            </div>
';
        $buffer .= $indent . '        </div>
';
...
';
    ...
    private function sectionC5ce88c6fb6ec4151f3c426f105e2896(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '                <section data-region="blocks-column" aria-label="';
                // 'str' section
                $value = $context->find('str');
