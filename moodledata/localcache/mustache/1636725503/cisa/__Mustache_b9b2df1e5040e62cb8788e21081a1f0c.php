...
class __Mustache_b9b2df1e5040e62cb8788e21081a1f0c extends Mustache_Template
{
...
';
        $buffer .= $indent . '        ';
        $value = $this->resolveValue($context->findDot('output.full_header_welcome'), $context);
        $buffer .= $value;
        $buffer .= '
';
        $buffer .= $indent . '
...
';
        ...
        $buffer .= '
';
        if ($partial = $this->mustache->loadPartial('theme_cisa/footer')) {
            $buffer .= $partial->renderInternal($context, $indent . '    ');
        }
        $buffer .= $indent . '</div>
';
