...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_heading('auth_cisasignup/pluginname', '',
        new lang_string('auth_cisasignupdescription', 'auth_cisasignup')));
...
/* Cut from settings otherwise borrowed from auth_email 
